      ...
      <View style={styles.container}>
        <View style={styles.footer}>
          <TouchableOpacity onPress={() => this.goToChatScreen()}>
            <View style={navigation.state.routeName === "Dialogs" ? [styles.footerChosen, {marginLeft: 30}]: [styles.footerElement, {marginLeft: 30}]}>
              <Icon name="chatbox-outline" size={40} color={navigation.state.routeName === "Dialogs" ? "#2E86FB": "black"}/>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => this.goToPeopleScreen()}>
            <View style={navigation.state.routeName === "People" || navigation.state.routeName === "Search" || navigation.state.routeName === "Requests" ? [styles.footerChosen]: styles.footerElement}>
              <Icon name="people-outline" size={40} color={navigation.state.routeName === "People" || navigation.state.routeName === "Search" || navigation.state.routeName === "Requests" ? "#2E86FB" : "black"}/>
            </View>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.goToEventsScreen()}>
            <View style={navigation.state.routeName === "Events" ? [styles.footerChosen, {marginRight: 30}]: [styles.footerElement, {marginRight: 30}]}>
              <Icon name="flag-outline" size={40} color={navigation.state.routeName === "Events" ? "#2E86FB": "black"}/>
            </View>
          </TouchableOpacity>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  footerElement:{
    ...
    alignItems: 'center',
    paddingBottom: 25,
    paddingLeft: SIZE_SCREEN.width - (SIZE_SCREEN.width * 0.9) - 20,
    paddingRight: SIZE_SCREEN.width - (SIZE_SCREEN.width * 0.9) - 20,
  },
  footerChosen: {
